...
if nargin < 4 % number of subdivisions per cycle has not been specified
        if nargin < 2 % bcl has not been specified
            if exist('lrdparams','file') % this file is generated by lrd_batch_eig.m
                load lrdparams bcl %LMM; this file contains variables: bcl stimstart L numpart
            else
                bcl = 1000;
...
%             else
%                 bcl = 1000;
%                 disp(['Using default BCL = ' num2str(Time) ' ms'])
%             end
%         end
    end
end
...
fname = ['lrddata/lrddata_1cell_b' num2str(bcl)]; % save simulation data in this file
save data data
