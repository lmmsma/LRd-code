...
%    sortedw_frominv = w_frominv(:,eigsortind);
    ...
    for jj = 1:numberofmodes
        ...
        cdotvchosen = cdotvnb; 
        cmagvmagchosen = cmagvmagnb;
        obsvmagchosen = obsvmagnb; 
        sortedeigchosenv = sortedeignb; 

        bdotwchosen = bdotwnb; 
        bmagwmagchosen = bmagwmagnb;
        ctrbmagchosen = ctrbmagnb; 
        sortedeigchosenw = sortedeignb; 
